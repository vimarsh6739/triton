...
def _compose_pipeline_hook(previous_hook, spec: _DiffSpec):

    def autodiff_stages_hook(self=None, stages=None, options=None, language=None, capability=None):
...
class _AutodiffKernel:
    ...
    def __init__(self, kernel, *, mode: str, arg_activities: Iterable[str | None] | None, enzyme_opt: str | None,
        ...
        functools.update_wrapper(self, kernel, updated=())
